<script>
  ...
  import Gradie from "../assets/gradie-sign-up.png";
  import Snipper from "../assets/snippet-page.png";
  import SignUpForm from "../assets/sign-up-page.png";
  import UnifeedBlog from "../assets/unifeed-blog.png";
  import Insure from "../assets/insure-landing-page.png";
  import LoopStudios from "../assets/loopstudios-landing-page.png";
  import SunnySide from "../assets/sunnyside-agency-landing-page.png";
  import Fylo from "../assets/fylo-landing-page.png";
  import Chirp from "../assets/chirp-page.png";
  import Clipboard from "../assets/clipboard-landing-page.png";
  import LandingPage from "../assets/landing-page.png";
  import Commune from "../assets/commune-waitlist.png";
</script>
    ...
    <div class="">
      ...
      <p class="font-[400] text-[#999999] px-0 pb-14 text-base md:text-lg">
        A design from <a
          ...
          >codewell</a
        > for a website that allows you create fully customizable code snippets in
        a matter of seconds right from your browser.
      </p>
    </div>
    <div class="">
    ...
    <div class="">
      ...
      <p class="font-[400] text-[#999999] px-0 pb-14 text-base md:text-lg">
        A design from <a
          ...
          >codewell</a
        > for a blog website with several interesting articles.
      </p>
    </div>
    <div class="">
      <img src={Commune} alt="" />
      ...
      <p class="font-[400] text-[#999999] px-0 pb-14 text-base md:text-lg">
        Another design from <a
          ...
          >codewell</a
        > for a website that offers you the tools to build a highly engaged community
    ...
    <div class="">
      ...
      <p class="font-[400] text-[#999999] px-0 pb-14 text-base md:text-lg">
        Another design from <a
          ...
          >frontendmentor</a
        > for a full-service creative agency specializing in helping brands grow
        fast. They help you engage your clients through compelling visuals that do
    ...
    <div class="">
      ...
      <p class="font-[400] text-[#999999] px-0 pb-14 text-base md:text-lg">
        Another design from <a
          ...
          >frontendmentor</a
        > for a website where you can store all your most important files and access
        them whenever you need as well as share and collaborate with friends and
        co-workers.
      </p>
    </div>
    <div class="">
      ...
      <p class="font-[400] text-[#999999] px-0 pb-14 text-base md:text-lg">
        A design from <a
          ...
          >codewell</a
        > for a twitter analytics website that helps you better understand your audience,
        which tweets they like and when they are most active.
      </p>
    </div>
    <div class="">
      ...
      <p class="font-[400] text-[#999999] px-0 pb-14 text-base md:text-lg">
        A design from <a
          ...
          >frontendmentor</a
        > for a website that lets you track everything you copy.
      </p>
    </div>
    <div class="">
