...
<div id="about" class="bg-[#6d7f97] py-8 px-4 md:px-0">
  ...
  >
    <div>
      ...
      >
        The experience I've had so far working with frontend web technolgies to
        create appealing user interfaces has allowed me to develop a skillset
        that helps me in not just development, but in every aspect of my
        everyday life.
      </p>
    ...
    <div>
      <p
        class="font-[400] text-[#d9d9d9] text-base md:text-lg w-full md:w-96 pt-4"
      >
        As a developer, I believe I have everything available to me and all that
        is holding me back is myself.
      </p>
